...
<div class="item-form">
    ...
    <?= \app\modules\portfolio\widgets\ImageGallery::widget(['model' => $model, 'field' => 'thumb1']); ?>
    ...
    <div class="form-group">
        <?= Html::submitButton($model->isNewRecord ? Yii::t('modules/blog', 'Create') : Yii::t('modules/blog', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
